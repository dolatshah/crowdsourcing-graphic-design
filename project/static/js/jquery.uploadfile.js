        ...
        function createCutomInputFile(obj, group, s, uploadLabel) {
            ...
            if(s.nestedForms) {
                ...
                fileInput.css({
                    ...
                    'cursor': 'pointer',
                    'top': '0px',
                    'width': '100%', //edited by htalatian
                    'height': '100%', //edited by htalatian
                    'left': '0px',
                    'z-index': '100',
                    'opacity': '0.0',
        ...
        function ajaxFormSubmit(form, s, pd, fileArray, obj) {
                    ...
                    if(s.showStatusAfterSuccess) {
                        if(s.showDone) {
                            ...
                            pd.done.click(function () {
                                ...
                                pd.statusbar.remove();
								window.location.reload(); //added by htalatian
                            });
                        } else {
                            pd.done.hide();
                        }
            ...
            if(s.autoSubmit) {
                ...
                if(s.showCancel) {
                    pd.cancel.show();
                    pd.cancel.click(function () {
						$("#description").hide(); //added by htalatian	
						$("#startUpload").hide(); //added by htalatian	
                        form.remove();
                        pd.statusbar.remove();
                        obj.selectedFiles -= fileArray.length; //reduce selected File count
                        updateFileCounter(s, obj);
