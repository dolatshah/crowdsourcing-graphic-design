...
(function($) {
    ...
    TC_Instance.prototype.initialize = function() {
        ...
        for (var key in this.data.text_elements) {
            ...
            headerElement.css("font-size", Math.round(0.14 * this.data.attributes.item_size));//edited by htalatian
            headerElement.css("line-height", Math.round(0.07 * this.data.attributes.item_size) + "px");//edited by htalatian
            headerElement.appendTo(textElement);
            
            var numberElement = $("<span>");
            numberElement.css("font-size", Math.round(0.21 * this.data.attributes.item_size));//edited by htalatian
            numberElement.css("line-height", Math.round(0.14 * this.data.attributes.item_size) + "px");//edited by htalatian
